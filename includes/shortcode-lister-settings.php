...
function shortcode_lister_welcome_tab(){
	global $shortcode_lister_active_tab; ?>
	<a class="nav-tab <?php echo $shortcode_lister_active_tab == 'welcome' || '' ? 'nav-tab-active' : ''; ?>" href="<?php echo admin_url( 'options-general.php?page=shortcode-lister-settings&tab=welcome' ); ?>"><?php _e( 'Shortcode Lister', 'shortcode-lister' ); ?> </a>
	<?php
}
